...
const simulatedResult = setupDemoCustomerSession({
  customerEmail: " Customer@Example.com ",
});

assert.equal(simulatedResult.success, true);
assert.equal(simulatedResult.customerEmail, "customer@example.com");
assert.equal(simulatedResult.emailConfigured, false);
